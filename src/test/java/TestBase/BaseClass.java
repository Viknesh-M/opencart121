...
public class BaseClass {
	...
	public void setup(String os, String br) throws IOException, InterruptedException 
	{
		...
		//FileReader file = new FileReader("//opencart121//src//test//resources//config.properties");
		p =new Properties();
		p.load(file);
		...
		if(p.getProperty("execution_env").equalsIgnoreCase("remote")){
			...
			driver=new RemoteWebDriver(new URL("http://10.193.102.32:4444/wd/hub"),capabilities);
		}
